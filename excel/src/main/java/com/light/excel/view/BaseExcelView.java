...
public class BaseExcelView extends AbstractXlsView {
    ...
    protected CellStyle buildDefaultCellStyle(final Workbook workbook) {
        ...
        defaultCellStyle.setRightBorderColor(HSSFColorPredefined.GREY_50_PERCENT.getIndex());
        defaultCellStyle.setBorderBottom(BorderStyle.THIN); //下边框
        defaultCellStyle.setBorderLeft(BorderStyle.THIN);//左边框
        defaultCellStyle.setBorderTop(BorderStyle.THIN);//上边框
        defaultCellStyle.setBorderRight(BorderStyle.THIN);//右边框
    ...
    protected CellStyle buildDefaultHeaderCellStyle(final Workbook workbook) {
        ...
        cellStyle.setRightBorderColor(HSSFColorPredefined.GREY_50_PERCENT.getIndex());

...
public class SwaggerConfiguration {
	 ...
	 */
	@Bean
	public Docket swaggerSpringfoxDocket(final WebProperties bizfuseWebProperties) {
		...
		// 配置支持token方式认证
		docket.securitySchemes(Arrays.asList(securityScheme()));
		this.log.info(Constants.CONFIG_LOG_MARK, "Swagger enabled, Access URL path: /swagger-ui.html");
		return docket;
	}

	private SecurityScheme securityScheme() {
		SecurityScheme accessToken = new ApiKey("access-token", "Authorization", "header");
		return accessToken;
	}
}

...
import com.light.generator.impl.ControllerGenerator;
import com.light.generator.impl.ConvertorGenerator;
import com.light.generator.impl.DtoGenerator;
import com.light.generator.impl.RepositoryGenerator;
import com.light.generator.impl.ServiceGenerator;
import com.light.generator.impl.ServiceImplGenerator;
...
public class GeneratorStarter {
    ...
    public static void main(final String[] args) throws ClassNotFoundException {
        if (args.length < 2) {
            ...
            System.out.println("1. Model包路径: modelBasePackage=com.light.generator.model");
            ...
            System.out.println("modelBasePackage=com.light.generator.model");
            System.out.println("models=User,Member,Role");
            System.out.println("output=file");
            System.out.println("override=true");
            System.out.println("longId=true");
            System.out.println("*****************参考配置*******************");
            return;
        }
        ...
        if (args.length >= 5) {
        	isLongTypeId = Boolean.valueOf(args[5].trim().replace("longId=", "").trim());
        }
        GeneratorStarter.instance().generateCode(basePackage, entities, OutputType.valueOf(output), override, isLongTypeId);
    }
     ...
     */
    public void generateCode(String basePackage, String[] entities, OutputType outputType, boolean override, boolean isLongTypeId) throws ClassNotFoundException {
        ...
        for (final String modelClass : entities) {
            ...
            config.setLongTypeId(isLongTypeId);
